...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Stage 2: Physician-style report generation (GMC Calicut, $\sim$~37K annotated samples)
    \end{enumerate}
...
\vspace{0.4em}
\small Evaluated on 100 samples. MVLMERG outperforms all baselines across all 5 metrics.
\end{frame}
...
\begin{itemize}
    ...
    \item Integrated system prompts and Chain‑of‑Thought reasoning to produce \textbf{concise, transparent, and clinically interpretable} reports.
        \item Achieved state-of-the-art: CIDEr 0.0531, ROUGE-L 0.2632, METEOR 0.1187, BLEU-4 0.0006, BERTScore 0.8760.
\end{itemize}
\vspace{1em}
