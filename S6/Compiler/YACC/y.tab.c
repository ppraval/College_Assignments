...
{
  "\"end of file\"", "error", "\"invalid token\"", "IF", "ELSE", "COND",
  "OTHER", "'('", "')'", "$accept", "program", "stmt", YY_NULLPTR
};
...
{
       2,     3,     6,     3,     4,     9,     4,    11,     7,     8,
      10
};

static const yytype_int8 yycheck[] =
{
       0,     3,     7,     3,     6,     8,     6,    10,     5,     8,
       4
};
...
#line 1120 "y.tab.c"
  ...
  case 5: /* stmt: IF '(' COND ')' stmt ELSE stmt  */
#line 24 "nestedif2.y"
        {
