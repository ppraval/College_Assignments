"""
FiD-BART: Fusion-in-Decoder BART for Multi-Document Summarization
...
class BartForMultiConditionalGeneration(BartForConditionalGeneration):
    """
    BART model extended to handle multiple input documents using Fusion-in-Decoder approach
    """
    ...
    def forward(
        ...
        **kwargs
        ...
        Args:
            Standard BART forward arguments
